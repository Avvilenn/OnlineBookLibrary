    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="masthead-brand">ONLINE BOOK LIBRARY</h3>
                    <nav>
            ...
            <div class="inner cover">
                <h1 class="cover-heading">Result of adding a book to library: </h1>
                <p class="lead">${resultOfAdd} <br> You can try to add another book at library !</p>
                <p class="lead">
                    <a href="addbook.jsp" class="btn btn-lg btn-default">Add new one</a>
                </p>
            </div>
            <hr>
